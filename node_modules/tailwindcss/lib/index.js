...
const getConfigFunction = config => () => {
  if (_lodash.default.isUndefined(config) && !_lodash.default.isObject(config)) {
    return (0, _resolveConfig.default)([...getDefaultConfigs(_defaultConfigStub.default)]);
  ...
  return (0, _resolveConfig.default)([configObject, ...getDefaultConfigs(configObject)]);
};
